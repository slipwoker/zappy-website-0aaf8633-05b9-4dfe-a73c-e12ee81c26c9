        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '0aaf8633-05b9-4dfe-a73c-e12ee81c26c9',
                name: formData.name,
            ...
            // Don't break existing functionality - error is logged but form continues
          }
        })();
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בהמתנה להצעות שם - המשתמשת מחפשת שם בהקשר של קונסטלציה והתמקדות, משהו שמתאים לעבודה עם דורות/נשים/אמא משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
